...
const Posts = () => {
    const posts = [
        {imageUser: meowed, nomeUser: "meowed", imagePost: gatoTelefone, imageLike: respondeai, userLike: "respondeai",  textoLike: "outras 101523 pessoas"},
        {imageUser: barked, nomeUser: "barked", imagePost: cachorro, imageLike: adorableAnimals, userLike: "adorable_animals",  textoLike: "outras 99159 pessoas"},
        {imageUser: meowed, nomeUser: "meowed", imagePost: yuyu, imageLike: respondeai, userLike: "respondeai",  textoLike: "outras 10259 pessoas"}
    ]
    return(
                ...
                <div className={styles.containerPost} key={index}>
                    ...
                    <div className={styles.containerIcons}>
                        <div className={styles.icons}>
                            <img src={heartIcon} alt="imagem de um icone de coração para like" />
                        ...
                        <img className={styles.iconVector} src={vector} alt="imagem de um icone de vector para salvar o post" />
                    </div>
